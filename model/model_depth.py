...
import math
from module.PGCU_depth import *

# 换成spe attn
# HS的上采样换成PGCU
# PGCU中 L的DSblock卷积换成depth-wise
...
class PSRTnet(nn.Module):
    def __init__(self, args):
        ...
        init_w(self.w)
        self.upsample = PGCU(Channel=31, VecLen=124, NumberBlocks=3)
    ...
    def forward(self, rgb, lms):
        ...
        self.rgb = rgb
        self.lms = lms
        self.lms = self.upsample(self.rgb, self.lms)
