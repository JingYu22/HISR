...
def args_parser():
    ...
    parser.add_argument('--dataroot', type=str, default='/data/yj/PSRT/cave_x4')
    ...
    parser.add_argument('--model_path', type=str, 
                            default= './checkpoints/PSRT_cave_x4_202303121727/model_epoch_2000.pth.tar',
                            help='path for trained encoder')
    parser.add_argument('--train_dir', type=str, default='/data/yj/PSRT/cave_x4',
                            help='directory for resized images')
    parser.add_argument('--val_dir', type=str, default='/data/yj/PSRT/cave_x4',
                            help='directory for resized images')
